...
import { signInSchema, signUpSchema, forgetPasswordSchema, sendTempPasswordSchema } from "./auth.validation.js";
import { signIn, signUp, sendTemp, forgetPassword } from "./index.js";
...
// Forget Password
router.get("/temporaryPassword",validation(sendTempPasswordSchema),async (req,res,next) => {
  try {
...
router.post("/forgetPassword",validation(forgetPasswordSchema),async (req,res,next) => {
  try {
